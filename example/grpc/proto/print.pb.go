...
var file_print_proto_rawDesc = []byte{
	0x0a, 0x0b, 0x70, 0x72, 0x69, 0x6e, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x23, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	0x18, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x4c, 0x0a, 0x08, 0x52, 0x65, 0x73,
	...
	0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0x3c, 0x0a, 0x0c, 0x50, 0x72, 0x69, 0x6e, 0x74,
	0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x2c, 0x0a, 0x07, 0x50, 0x72, 0x69, 0x6e, 0x74,
	0x4f, 0x4b, 0x12, 0x0e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65,
...
var file_print_proto_depIdxs = []int32{
	0, // 0: proto.PrintService.PrintOK:input_type -> proto.Request
	1, // 1: proto.PrintService.PrintOK:output_type -> proto.Response
...
func (c *printServiceClient) PrintOK(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/proto.PrintService/PrintOK", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PrintServiceServer interface {
	PrintOK(context.Context, *Request) (*Response, error)
}
...
func (*UnimplementedPrintServiceServer) PrintOK(context.Context, *Request) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PrintOK not implemented")
}
...
func _PrintService_PrintOK_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PrintServiceServer).PrintOK(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.PrintService/PrintOK",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PrintServiceServer).PrintOK(ctx, req.(*Request))
	}
...
var _PrintService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "PrintOK",
			Handler:    _PrintService_PrintOK_Handler,
		},
	},
