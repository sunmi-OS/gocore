// Package xhttp provides http client functions.
// Author: Jerry
package xhttp
...
// SendMultipartBodyMap send multipart body map
...
// EndBytes return http.Response and []byte
...
// EndStruct return http.Response and unmarshal to struct
...
// FormatURLParam format url param
